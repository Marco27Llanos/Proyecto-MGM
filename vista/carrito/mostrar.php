<section class="content">
    ...
    if (isset($_SESSION['carrito']))
        foreach ($data as $p) { 
            $cant = $_SESSION['carrito']->getCantidad($p['idequipo']);
                        ...
                        <tbody>
                            <tr>
                                <td width="20%">
                                    ...
                                    <hr>
                                    <a href="?ctrl=CtrlCarrito&accion=sacar&id=<?=$p['idequipo']?>&url=carrito&cant=<?=$cant?>" class="btn btn-danger">Eliminar</a>
                                </td>
                                <td>
                                    <h2><?=$p['nombre']?></h2>
                                ...
                                <td width="20%">
                                    ...
                                    <h5>Cantidad:</h5>
                                        <h4>
                                            <?=$cant;?>
                                            <a href="?ctrl=CtrlCarrito&accion=agregar&id=<?=$p['idequipo']?>&url=carrito"
                                                 class="btn btn-success">+</a>
                                            <a href="?ctrl=CtrlCarrito&accion=sacar&id=<?=$p['idequipo']?>&url=carrito"
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <a href="?ctrl=CtrlEquipo&accion=getCatalogo" 
