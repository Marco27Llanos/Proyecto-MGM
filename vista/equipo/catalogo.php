    ...
    <?php
        ...
        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
            ...
            <div class="card-footer">
                ...
                <a href="?ctrl=CtrlEquipo&accion=verDetalles&id=<?=$d['idequipo']?>&url=catalogo" class="btn btn-sm btn-success">
                    <i class="fas fa-user"></i> Ver detalles
                </a>
                <a href="?ctrl=CtrlCarrito&accion=agregar&id=<?=$d['idequipo']?>&url=catalogo" class="btn btn-sm btn-primary">
