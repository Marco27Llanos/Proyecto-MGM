    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="?ctrl=CtrlCliente&accion=cambiarClave" 
        ...
        $cantEquipos =isset($_SESSION['carrito'])?$_SESSION['carrito']->getNroEquipos():0;
      ?>
        <li class="nav-item">
          
          <a href="?ctrl=CtrlCarrito&accion=mostrar" 
          class="btn btn-app" title="Tiene <?= $cantEquipos?> Elementos en el Carrito">
            <span class="badge bg-warning"><?= $cantEquipos?></span>
